...
view uscente, aggiorna il puntatore, triggera il feedback sonoro di navigazione
e chiama \texttt{on\_enter} della nuova view.
...
(\texttt{fillRect} bianco + testo nero), tecnica che non richiede bitmap.
