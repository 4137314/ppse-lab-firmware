...
Il progetto ha evidenziato come il limite dei sistemi embedded moderni non sia più la potenza di calcolo bruta, ma l'efficienza nella gestione delle periferiche. La separazione dei task tra i due core (Core 1 per l'interfaccia grafica e Core 0 per il processamento asincrono e lo storage) ha permesso di mantenere una latenza di risposta ai pulsanti inferiore ai \qty{10}{ms}, nonostante il pesante carico di scrittura su memoria non volatile.
