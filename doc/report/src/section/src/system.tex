...
\begin{itemize}
    \item \textbf{Storage:} Gestione resiliente dei dati tramite il filesystem \textit{FatFS} e persistenza su Flash (\texttt{storage.h}).
