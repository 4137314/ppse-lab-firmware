...
Un aspetto fondamentale per questo progetto è stata la configurazione della partizione di memoria dedicata a \textbf{FatFS}. 
DA RIVEDERE ->Tramite il parametro \texttt{board\_build.filesystem\_size}, è stato possibile riservare una porzione specifica della Flash W25Q16 per l'archiviazione dei log.
...
NOTA: comandi principali in appendice! ANZI CITARE I COMANDI UFFICIALI PIO
