...
bool minmea_gps_parse(String* nmea_message){
    // For each nmea sentence determine the $GP identifier
    for(int j=0; j<NMEA_SENTENCE_COUNT; ++j){ 

        switch (minmea_sentence_id(nmea_message[j].c_str(), false)) {
                case MINMEA_SENTENCE_RMC: {
                    struct minmea_sentence_rmc frame;
                    if (minmea_parse_rmc(&frame, nmea_message[j].c_str())) {
                ...
                case MINMEA_SENTENCE_GGA: {
                    ...
                    if (minmea_parse_gga(&frame, nmea_message[j].c_str())) {
                ...
                case MINMEA_SENTENCE_GST: {
                    ...
                    if (minmea_parse_gst(&frame, nmea_message[j].c_str())) {
                ...
                */
                case MINMEA_SENTENCE_GSV: {
                    ...
                    if (minmea_parse_gsv(&frame, nmea_message[j].c_str())) {
                ...
                case MINMEA_SENTENCE_VTG: {
                    ...
                    if (minmea_parse_vtg(&frame, nmea_message[j].c_str())) {
                ...
                case MINMEA_SENTENCE_ZDA: {
                    ...
                    if (minmea_parse_zda(&frame, nmea_message[j].c_str())) {
