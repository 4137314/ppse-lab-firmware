 ...
 * * Questo header contiene le macro di configurazione per la striscia LED (WS2812B)
 * e i prototipi delle funzioni di animazione utilizzate per il feedback utente.
 * La gestione fisica dei LED è affidata alla libreria FastLED.
 */
...
#define COLOR_ORDER GRB     /**< Ordine dei canali colore (Green-Red-Blue) per il chipset utilizzato. */
/** @} */

/**
 * @brief Inizializza il controller FastLED con i parametri definiti nelle macro.
 */
void ledsInit();
...
/**
 * @brief Esegue un flash Giallo per segnalare il ritorno alla Home per inattività.
 */
