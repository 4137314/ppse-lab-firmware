 ...
 * * Questo header definisce l'interfaccia per il modulo GPS, incluse le mappature dei pin UART
 * per RP2040, le impostazioni di logging su filesystem e la struttura dati che aggrega
 * i risultati del parsing della libreria minmea.
 */
...
#define GPS_ACQUIRE_MAX_TRIES 30      /**< Tentativi massimi di lettura sentenze per ogni chiamata gpsAcquire. */
/** @} */
...
#define GPS_WRITE_FREQ 600000           /**< Frequenza minima di scrittura su Flash (ms) per protezione usura. */
/** @} */
 ...
 * * Questa struttura aggrega i diversi tipi di messaggi NMEA gestiti dalla libreria @c minmea.
 * Viene aggiornata ogni volta che una nuova stringa valida viene ricevuta dalla seriale.
 */
struct parsed_nmea{
